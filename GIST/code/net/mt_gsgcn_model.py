...
class Model(nn.Module):
    def __init__(self, in_channels, num_class, graph_args,
        ...
        self.data_bn = nn.BatchNorm1d(in_channels * self.graph.num_node)  # (3 * 7 = 21)
        ...
        self.st_gcn_networks = nn.ModuleList((
            ...
            #st_gcn(64, 64, kernel_size, 1, **kwargs),
            #st_gcn(64, 64, kernel_size, 1, **kwargs),
            st_gcn(64, 128, kernel_size, 2, **kwargs),#2
            #st_gcn(128, 128, kernel_size, 1, **kwargs),
            st_gcn(128, 256, kernel_size, 2, **kwargs),#2
...
class st_gcn(nn.Module):
    def __init__(self, in_channels, out_channels, kernel_size,
        ...
        self.output_bn = nn.BatchNorm2d(out_channels)  # ✅ 額外新增的 BN 層
    ...
    def forward(self, x, A):
        ...
        x = self.tcn(x) + res
        x = self.relu(x)
        x = self.output_bn(x)  # ✅ 每個 block 輸出後做 BatchNorm
        return x, A
